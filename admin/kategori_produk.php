...
<div class="container">
    ...
    <?php	
				...
				?>
    <div class="row col-md-6">
        <form action="kategori_produk.php?act=edit&&id=<?php echo $_GET['id'] ?>" method="post"
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-sm btn-success"
                        href="kategori_produk.php?act=edit&&id=<?php echo $data->id ?>">Edit <i
                            class="fa-solid fa-pen-to-square"></i> </a>
                    <a class="btn btn-sm btn-danger"
                        href="kategori_produk.php?act=delete&&id=<?php echo $data->id ?>">Delete <i
