...
<div class="container">
    ...
    <a class="btn btn-sm btn-primary" href="user.php?act=create">Tambah Data User <i class="fa-solid fa-user-plus"></i>
    </a>
    <hr>
    <?php
			if(!empty($_GET)){
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-sm btn-success" href="user.php?act=edit&&id=<?php echo $data->id ?>">Edit <i
                            class="fa-solid fa-user-pen"></i> </a>
                    <a class="btn btn-sm btn-danger" href="user.php?act=delete&&id=<?php echo $data->id ?>">Delete <i
