<?php
	...
	include"../inc/config.php"; //jadiin komentar
        ...
        <tbody>
            ...
            <tr <?php if($data->read == 0 ){ echo 'style="background:#cce9f8 !important;"'; } ?>>
                ...
                <td>
                    ...
                    <a class="btn btn-sm btn-success" href="pesanan.php?act=edit&&id=<?php echo $data->id ?>">Edit <i
                            class="fa-solid fa-pen-to-square"></i> </a>
                    <a class="btn btn-sm btn-danger" href="pesanan.php?act=delete&&id=<?php echo $data->id ?>">Delete <i
