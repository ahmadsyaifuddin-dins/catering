...
<body>
    <font color="black">
        <div class="col-md-9">
            ...
            if (!empty($_POST['form-order'])) {
                ...
                if ($difference->days >= 3) {
                    ...
                    if ($q) {
                        ...
                        $last = mysqli_fetch_array(mysqli_query($konek, "SELECT *FROM pesanan order by id DESC limit 1"));
                        ...
                        foreach ($cart as $id => $qty) {
                            ...
                            if (!empty($product)) {
                                ...
                                $ins = mysqli_query($konek, "insert into detail_pesanan Values(NULL,'$product[id]','$qty','$last[id]')");
                            }
                        }
            ...
            ?>
                    <div class="alert alert-danger">Tanggal Penggunakan terlalu mepet. Pemesanan paling sedikit 3 Hari sebelum
                        hari
                        H.</div>
            <?php
                }
                                    ...
                                    <tr class="barang-shop">
                                        ...
                                        <td>
                                            <div class="CartDescription">
                                                <h4> <a href="<?php echo $url; ?>menu.php?id=<?php echo $product['id'] ?>"><?= $product['nama'] ?></a>
                                                </h4>
                                                <div class="price">
